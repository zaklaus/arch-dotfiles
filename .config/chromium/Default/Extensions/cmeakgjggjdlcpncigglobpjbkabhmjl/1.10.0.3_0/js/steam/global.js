...
const VALID_LANGUAGES = ['bg', 'cs', 'de', 'en', 'es', 'fr', 'it', 'ka', 'lv', 'pl', 'pt', 'ro', 'ru', 'sv', 'tr', 'vi', 'uk', 'zh'];
...
const DELTA1MIN=6e4;
const MAIN_COUNTER_URL = (chrome.runtime.id === 'cmeakgjggjdlcpncigglobpjbkabhmjl'
  ? 'http://steaminventoryhelper.org/api/sih/counter'
  : 'http://loc.steaminventoryhelper.org/api/sih/counter');
const MAIN_API_URL = (chrome.runtime.id === 'cmeakgjggjdlcpncigglobpjbkabhmjl'
    ? 'http://steaminventoryhelper.org/api/sih'
