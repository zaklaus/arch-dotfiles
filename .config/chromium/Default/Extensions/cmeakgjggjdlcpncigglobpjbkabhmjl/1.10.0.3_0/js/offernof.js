    ...
    if (extprice) {
        for (var i = 0; i < details.responseHeaders.length; i++) {
            if (isCSPHeader(details.responseHeaders[i].name.toUpperCase())) {
                ...
                details.responseHeaders[i].value = details.responseHeaders[i].value.replace("; frame-src 'self'", " https://api.csgofast.com http://api.csgofast.com https://api.csgofast.in http://api.csgofast.in https://scmspy.com http://scmspy.com; frame-src 'self'");
